export const IndexMasterClasses = () => {
  return (
        ...
        <div class="grid lg:grid-cols-2 gap-x-4 gap-y-20 lg:gap-14">
          <div class="bg-fiolet relative pt-[127px] pb-[111px] px-4 md:px-12 isolate">
            ...
            <p class="mb-8 font-light text-base text-center max-w-[376px] mx-auto">
              ...
              какой-либо продукт просим предупредить организаторов. Организаторы
          ...
          <div class="flex flex-col bg-gray-5 relative pt-[127px] pb-[111px] px-4 md:px-12 isolate">
            ...
            <ul class="grid gap-4 list-circle pl-5 font-light text-lg mb-8 list-lightning">
              <li>
                сделают первые шаги в карвинге - искусстве художественной резки
                по овощам и фруктам
              </li>
              <li>
                познакомятся с инструментами для карвинга (очень острыми ножами,
                привезенными специально из Таиланда)
              </li>
              <li>
